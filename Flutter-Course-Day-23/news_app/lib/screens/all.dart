...
class _AllScreenState extends State<AllScreen> {
  ...
  Future getAllNews()async{
   final response = await http.get(Uri.parse("https://newsapi.org/v2/everything?q=tesla&from=${getCurrentDate()}&sortBy=publishedAt&apiKey=2f00c1f28f274a6696863ee658c591c3"));
   Map _allNews = {};
